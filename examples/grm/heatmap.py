...
def test_heatmap() -> None:
    ...
    grm.plot.heatmap(z=z, z_dims=(Y_DIM, X_DIM), xrange=(-2.0, 2.0), yrange=(0.0, pi))
    input("Press enter to continue")
    ...
    series: Iterable[Dict[str, grm.args._ElemType]] = [
        {"z": z, "z_dims": (Y_DIM, X_DIM), "xrange": (-4.25, -0.25), "yrange": (0.0, pi)},
        {"z": z, "z_dims": (Y_DIM, X_DIM), "xrange": (0.25, 4.25), "yrange": (0.0, pi)}
    ]
