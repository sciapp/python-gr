...
def polar_histogram_phiflip() -> None:
    theta = (0.1, 1.1, 5.4, 3.4, 2.3, 4.5, 3.2, 3.4, 5.6, 2.3, 2.1, 3.5, 0.6, 6.1)
    print("Polar histogram with phiflip...")
    grm.plot.polar_histogram(x=theta, phiflip=True)
    input("Press enter to continue")


def polar_histogram_nbins() -> None:
    theta = (0.1, 1.1, 5.4, 3.4, 2.3, 4.5, 3.2, 3.4, 5.6, 2.3, 2.1, 3.5, 0.6, 6.1)
    print("Polar histogram with nbins = 3...")
    grm.plot.polar_histogram(x=theta, nbins=3)
    input("Press enter to continue")
...
def polar_histogram_colormap() -> None:
    ...
    grm.plot.polar_histogram(x=theta, xcolormap=44, ycolormap=44, draw_edges=1)
    input("Press enter to continue")
...
def polar_histogram_rlim() -> None:
    theta = (0.1, 1.1, 5.4, 3.4, 2.3, 4.5, 3.2, 3.4, 5.6, 2.3, 2.1, 3.5, 0.6, 6.1)
    rlim = (0.25, 0.5)
    print("Polar histogram with rlim...")
    grm.plot.polar_histogram(x=theta, rlim=rlim)
    input("Press enter to continue")
...
def polar_histogram_philim() -> None:
    ...
    print("Polar histogram with philim...")
    grm.plot.polar_histogram(x=theta, philim=philim)
    input("Press enter to continue")
