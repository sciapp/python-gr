...
def test_marginalheatmap() -> None:
    ...
    grm.plot.marginalheatmap(x=xi, y=yi, z=zi, marginalheatmap_kind="all", algorithm="sum")
    input("Press enter to continue")

    print("plot a special type of marginalheatmap where only one line and column is shown")
    grm.plot.marginalheatmap(x=xi, y=yi, z=zi, marginalheatmap_kind="line", algorithm="sum", xind=1, yind=2)
    input("Press enter to continue")
